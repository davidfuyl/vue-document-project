                    ...
                    <el-container>
                        <el-main>
                            <el-table :data="tableData" height="420"  @selection-change="selectChange" stripe border>
                                ...
                                <el-table-column prop="docType" :label="$t('common.docType')" sortable width="135"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            createDoc() {
                ...
                let routerJump = this.$router.resolve({ path: '/createDoc',query: { id: 123, name: 'hello'} });
